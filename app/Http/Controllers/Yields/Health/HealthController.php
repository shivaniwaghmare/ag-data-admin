...
namespace App\Http\Controllers\Yields\Health;
...
use App\Services\Yields\Health\HealthService;
...
class HealthController extends Controller
{
     ...
     */
    private string $baseUrl = "/yields/health";

    /**
     * Injects Health Service dependency through the constructor
     *
     * @param HealthService $service
     *
     * @return Void
     */
    public function __construct(HealthService $service, Health $model)
    {
    ...
    /**
     * Displays a form to add new Health
     *
     *@link http://yields/health/create/
     *
     *@method GET
     *
     * @return Response
    ...
    /**
     * Displays a form with values to update Health
     *
     *@link http://yields/health/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findHealthById($id);
     ...
     *
     *@link http://yields/health/update/id
     *
     *@method PATCH/PUT
     *
     * @param HealthRequest  $request The request object
