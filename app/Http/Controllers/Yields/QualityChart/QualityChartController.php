...
namespace App\Http\Controllers\Yields\QualityChart;
...
use App\Services\Yields\QualityChart\QualityChartService;
use App\Http\Requests\Yields\QualityChart\QualityChartRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class QualityChartController extends Controller
{
     ...
     */
    private string $baseUrl = "/yields/quality-chart";

    /**
     * Injects QualityChart Service dependency through the constructor
     *
     * @param QualityChartService $service
     *
     * @return Void
     */
    public function __construct(QualityChartService $service, QualityChart $model)
    {
     ...
     *
     *@link http://yields/quality-chart
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new QualityChart
     *
     *@link http://yields/quality-chart/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://yields/quality-chart/store
     *
     *@method POST
     *
     ...
     */
    public function store(QualityChartRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update QualityChart
     *
     *@link http://yields/quality-chart/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findQualityChartById($id);
     ...
     *
     *@link http://yields/quality-chart/update/id
     *
     *@method PATCH/PUT
     *
     * @param QualityChartRequest  $request The request object
