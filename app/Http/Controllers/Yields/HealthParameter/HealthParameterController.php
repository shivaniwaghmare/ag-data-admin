...
namespace App\Http\Controllers\Yields\HealthParameter;
...
use App\Services\Yields\HealthParameter\HealthParameterService;
...
class HealthParameterController extends Controller
{
     ...
     */
    private string $baseUrl = "/yields/health-parameter";

    /**
     * Injects HealthParameter Service dependency through the constructor
     *
     * @param HealthParameterService $service
     *
     * @return Void
     */
    public function __construct(HealthParameterService $service, HealthParameter $model)
    {
     ...
     *
     *@link http://yields/health-parameter
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new HealthParameter
     *
     *@link http://yields/health-parameter/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://yields/health-parameter/store
     *
     *@method POST
     *
     ...
     */
    public function store(HealthParameterRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update HealthParameter
     *
     *@link http://yields/health-parameter/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findHealthParameterById($id);
     ...
     *
     *@link http://yields/health-parameter/update/id
     *
     *@method PATCH/PUT
     *
     * @param HealthParameterRequest  $request The request object
