...
namespace App\Http\Controllers\Agrochemicals\Agrochemical;
...
use App\Services\Agrochemicals\Agrochemical\AgrochemicalService;
...
class AgrochemicalController extends Controller
{
    ...
    */
    private string $baseUrl = "/agrochemicals/agrochemical";

    /**
     * Injects Agrochemical Service dependency through the constructor
     *
     * @param AgrochemicalService $service
     *
     * @return Void
     */
    public function __construct(AgrochemicalService $service)
    {
     ...
     *
     *@link http://agrochemicals/agrochemical
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new Agrochemical
     *
     *@link http://agrochemicals/agrochemical/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agrochemicals/agrochemical/store
     *
     *@method POST
     *
     ...
     */
    public function store(AgrochemicalRequest $request)
    {
        $data = null;
       $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update Agrochemical
     *
     *@link http://agrochemicals/agrochemical/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findAgrochemicalById($id);
     ...
     *
     *@link http://agrochemicals/agrochemical/update/id
     *
     *@method PATCH/PUT
     *
     * @param AgrochemicalRequest  $request The request object
