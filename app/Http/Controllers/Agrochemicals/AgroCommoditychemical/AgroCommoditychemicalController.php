...
namespace App\Http\Controllers\Agrochemicals\AgroCommoditychemical;
...
use App\Services\Agrochemicals\AgroCommoditychemical\AgroCommoditychemicalService;
use App\Http\Requests\Agrochemicals\AgroCommoditychemical\AgroCommoditychemicalRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class AgroCommoditychemicalController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/agrochemicals/agro-commodity-chemical";

    /**
     * Injects AgroCommoditychemical Service dependency through the constructor
     *
     * @param AgroCommoditychemicalService $service
     *
     * @return Void
     */
    public function __construct(AgroCommoditychemicalService $service)
    {
     ...
     *
     *@link http://agrochemicals/agro-commoditychemical
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new AgroCommoditychemical
     *
     *@link http://agrochemicals/agro-commoditychemical/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agrochemicals/agro-commoditychemical/store
     *
     *@method POST
     *
     ...
     */
    public function store(AgroCommoditychemicalRequest $request)
    {
        $data = null;
       $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update AgroCommoditychemical
     *
     *@link http://agrochemicals/agro-commoditychemical/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findAgroCommoditychemicalById($id);
     ...
     *
     *@link http://agrochemicals/agro-commoditychemical/update/id
     *
     *@method PATCH/PUT
     *
     * @param AgroCommoditychemicalRequest  $request The request object
