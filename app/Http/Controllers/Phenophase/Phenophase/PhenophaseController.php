...
namespace App\Http\Controllers\Phenophase\Phenophase;
...
use App\Services\Phenophase\Phenophase\PhenophaseService;
...
class PhenophaseController extends Controller
{
     ...
     */
    private string $baseUrl = "/phenophase/phenophase";
     ...
     * @return Void
     */
    public function __construct(PhenophaseService $service, Phenophase $model)
    {
     ...
     *
     *@link http://phenophase/phenophase
     *
     *@method GET
     *
     ...
     *
     *@link http://phenophase/phenophase/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://phenophase/phenophase/store
     *
     *@method POST
     *
     ...
     *
     *@link http://phenophase/phenophase/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findPhenophaseById($id);
     ...
     *
     *@link http://phenophase/phenophase/update/id
     *
     *@method PATCH/PUT
     *
