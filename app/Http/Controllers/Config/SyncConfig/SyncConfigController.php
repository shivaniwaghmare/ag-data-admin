...
namespace App\Http\Controllers\Config\SyncConfig;
...
use App\Services\Config\SyncConfig\SyncConfigService;
...
class SyncConfigController extends Controller
{
    ...
    */
    private string $baseUrl = "/config/sync-configaration";

    /**
     * Injects SyncConfig Service dependency through the constructor
     *
     * @param SyncConfigService $service
     *
     * @return Void
     */
    public function __construct(SyncConfigService $service)
    {
    ...
    /**
     * Displays a form to add new SyncConfig
     *
     *@link http://config/sync-config/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://config/sync-config/store
     *
     *@method POST
     *
     ...
     */
    public function store(SyncConfigRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update SyncConfig
     *
     *@link http://config/sync-config/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findSyncConfigById($id);
     ...
     *
     *@link http://config/sync-config/update/id
     *
     *@method PATCH/PUT
     *
     * @param SyncConfigRequest  $request The request object
