...
namespace App\Http\Controllers\Stress\Stage;
...
use App\Services\Stress\Stage\StageService;
...
class StageController extends Controller
{
     ...
     */
    private string $baseUrl = "/stress/stage";
     ...
     *
     *@link http://stress/stage/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStageById($id);
     ...
     *
     *@link http://stress/stage/update/id
     *
     *@method PATCH/PUT
     *
