...
namespace App\Http\Controllers\Stress\StressType;
...
use App\Services\Stress\StressType\StressTypeService;
use App\Http\Requests\Stress\StressType\StressTypeRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class StressTypeController extends Controller
{
    protected $service;
     ...
     */
    private string $baseUrl = "/stress/stress-type";

    /**
     * Injects StressType Service dependency through the constructor
     *
     * @param StressTypeService $service
     *
     * @return Void
     */
    public function __construct(StressTypeService $service)
    {
    ...
    /**
     * Displays a form to add new StressType
     *
     *@link http://stress/stress-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://stress/stress-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(StressTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update StressType
     *
     *@link http://stress/stress-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStressTypeById($id);
     ...
     *
     *@link http://stress/stress-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param StressTypeRequest  $request The request object
