...
namespace App\Http\Controllers\Stress\ControlMeasures;
...
use App\Services\Stress\ControlMeasures\ControlMeasuresService;
use App\Http\Requests\Stress\ControlMeasures\ControlMeasuresRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class ControlMeasuresController extends Controller
{
    protected $service;
     ...
     */
    private string $baseUrl = "/stress/control-measures";

    /**
     * Injects ControlMeasures Service dependency through the constructor
     *
     * @param ControlMeasuresService $service
     *
     * @return Void
     */
    public function __construct(ControlMeasuresService $service)
    {
     ...
     *
     *@link http://stress/control-measures
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new ControlMeasures
     *
     *@link http://stress/control-measures/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://stress/control-measures/store
     *
     *@method POST
     *
     ...
     */
    public function store(ControlMeasuresRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update ControlMeasures
     *
     *@link http://stress/control-measures/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findControlMeasuresById($id);
     ...
     *
     *@link http://stress/control-measures/update/id
     *
     *@method PATCH/PUT
     *
     * @param ControlMeasuresRequest  $request The request object
