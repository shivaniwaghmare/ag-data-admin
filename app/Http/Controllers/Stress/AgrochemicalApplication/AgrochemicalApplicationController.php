...
namespace App\Http\Controllers\Stress\AgrochemicalApplication;
...
use App\Services\Stress\AgrochemicalApplication\AgrochemicalApplicationService;
use App\Http\Requests\Stress\AgrochemicalApplication\AgrochemicalApplicationRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class AgrochemicalApplicationController extends Controller
{
    protected $service;
     ...
     */
    private string $baseUrl = "/stress/agrochemical-application";

    /**
     * Injects AgrochemicalApplication Service dependency through the constructor
     *
     * @param AgrochemicalApplicationService $service
     *
     * @return Void
     */
    public function __construct(AgrochemicalApplicationService $service)
    {
     ...
     *
     *@link http://stress/agrochemical-application
     *
     *@method GET
     *
    ...
    public function index(Request $request): Response
    {
        ...
        try {
            return Inertia::render(
                ...
                props: [
                    'type' => 'List',
                    'title' => "All Agrochemical Application",
    ...
    /**
     * Displays a form to add new AgrochemicalApplication
     *
     *@link http://stress/agrochemical-application/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://stress/agrochemical-application/store
     *
     *@method POST
     *
     ...
     */
    public function store(AgrochemicalApplicationRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update AgrochemicalApplication
     *
     *@link http://stress/agrochemical-application/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findAgrochemicalApplicationById($id);
     ...
     *
     *@link http://stress/agrochemical-application/update/id
     *
     *@method PATCH/PUT
     *
     * @param AgrochemicalApplicationRequest  $request The request object
