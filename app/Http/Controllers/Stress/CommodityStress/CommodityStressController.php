...
namespace App\Http\Controllers\Stress\CommodityStress;
...
use App\Services\Stress\CommodityStress\CommodityStressService;
use App\Http\Requests\Stress\CommodityStress\CommodityStressRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class CommodityStressController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/stress/commodity-stress";

    /**
     * Injects CommodityStress Service dependency through the constructor
     *
     * @param CommodityStressService $service
     *
     * @return Void
     */
    public function __construct(CommodityStressService $service)
    {
     ...
     *
     *@link http://stress/commodity-stress
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CommodityStress
     *
     *@link http://stress/commodity-stress/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://stress/commodity-stress/store
     *
     *@method POST
     *
     ...
     */
    public function store(CommodityStressRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update CommodityStress
     *
     *@link http://stress/commodity-stress/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findCommodityStressById($id);
     ...
     *
     *@link http://stress/commodity-stress/update/id
     *
     *@method PATCH/PUT
     *
     * @param CommodityStressRequest  $request The request object
