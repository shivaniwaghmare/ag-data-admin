...
namespace App\Http\Controllers\Stress\SeedTreatment;
...
use App\Services\Stress\SeedTreatment\SeedTreatmentService;
...
class SeedTreatmentController extends Controller
{
    ...
    */
    private string $baseUrl = "/stress/seed-treatment";

    /**
     * Injects SeedTreatment Service dependency through the constructor
     *
     * @param SeedTreatmentService $service
     *
     * @return Void
     */
    public function __construct(SeedTreatmentService $service)
    {
     ...
     *
     *@link http://stress/seed-treatment
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new SeedTreatment
     *
     *@link http://stress/seed-treatment/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://stress/seed-treatment/store
     *
     *@method POST
     *
     ...
     */
    public function store(SeedTreatmentRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update SeedTreatment
     *
     *@link http://stress/seed-treatment/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findSeedTreatmentById($id);
     ...
     *
     *@link http://stress/seed-treatment/update/id
     *
     *@method PATCH/PUT
     *
     * @param SeedTreatmentRequest  $request The request object
