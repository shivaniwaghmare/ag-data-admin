...
namespace App\Http\Controllers\Agriculture\FarmMachinery;
...
use App\Services\Agriculture\FarmMachinery\FarmMachineryService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Agriculture\FarmMachinery\FarmMachineryRequest;

class FarmMachineryController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/farm-machinery";

    /**
     * Injects FarmMachinery Service dependency through the constructor
     *
     * @param FarmMachineryService $service
     *
     * @return Void
     */
    public function __construct(FarmMachineryService $service, FarmMachinery $model)
    {
     ...
     *
     *@link http://agriculture/farm-machinery
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmMachinery
     *
     *@link http://agriculture/farm-machinery/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create(): Response
    {
        return Inertia::render(
            ...
            props: [
                ...
                'url' => $this->baseUrl,
                'downloadUrl' => config('app.s3_url') . 'examples.xlsx',
                'importUrl' => 'import',
     ...
     *
     *@link http://agriculture/farm-machinery/store
     *
     *@method POST
     *
     * @param FarmMachineryRequest $request
     *
     * @return \Illuminate\Http\RedirectResponse
     */
    public function store(FarmMachineryRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update FarmMachinery
     *
     *@link http://agriculture/farm-machinery/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmMachineryById($id);
     ...
     *
     *@link http://agriculture/farm-machinery/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmMachineryRequest  $request The request object
     * @param int $id The request object
     *
     * @return request
     */
    public function update(FarmMachineryRequest $request, int $id)
    {
        $data = null;
        $code = "SUCCESS";
        try {
