...
namespace App\Http\Controllers\Agriculture\DisposalMethod;
...
use App\Services\Agriculture\DisposalMethod\DisposalMethodService;
...
class DisposalMethodController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/disposal-method";

    /**
     * Injects DisposalMethod Service dependency through the constructor
     *
     * @param DisposalMethodService $service
     *
     * @return Void
     */
    public function __construct(DisposalMethodService $service, DisposalMethod $model)
    {
     ...
     *
     *@link http://agriculture/disposal-method
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new DisposalMethod
     *
     *@link http://agriculture/disposal-method/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/disposal-method/store
     *
     *@method POST
     *
     ...
     */
    public function store(DisposalMethodRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update DisposalMethod
     *
     *@link http://agriculture/disposal-method/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findDisposalMethodById($id);
     ...
     *
     *@link http://agriculture/disposal-method/update/id
     *
     *@method PATCH/PUT
     *
     * @param DisposalMethodRequest  $request The request object
