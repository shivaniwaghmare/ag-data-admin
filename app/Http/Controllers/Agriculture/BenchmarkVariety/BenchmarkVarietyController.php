...
namespace App\Http\Controllers\Agriculture\BenchmarkVariety;
...
use App\Services\Agriculture\BenchmarkVariety\BenchmarkVarietyService;
use App\Http\Requests\Agriculture\BenchmarkVariety\BenchmarkVarietyRequest;

class BenchmarkVarietyController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/benchmark-variety";

    /**
     * Injects BenchmarkVariety Service dependency through the constructor
     *
     * @param BenchmarkVarietyService $service
     *
     * @return Void
     */
    public function __construct(BenchmarkVarietyService $service, BenchmarkVariety $model)
    {
     ...
     *
     *@link http://agriculture/benchmark-variety
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new BenchmarkVariety
     *
     *@link http://agriculture/benchmark-variety/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create(): Response
    {
        return Inertia::render(
            ...
            props: [
                ...
                'downloadUrl' => config('app.s3_url') . 'agri_benchmark_variety.xlsx',
                'importUrl' => 'import',
                'url' => $this->baseUrl,
     ...
     *
     *@link http://agriculture/benchmark-variety/store
     *
     *@method POST
     *
     ...
     */
    public function store(BenchmarkVarietyRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update BenchmarkVariety
     *
     *@link http://agriculture/benchmark-variety/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findBenchmarkVarietyById($id);
     ...
     *
     *@link http://agriculture/benchmark-variety/update/id
     *
     *@method PATCH/PUT
     *
     * @param BenchmarkVarietyRequest  $request The request object
