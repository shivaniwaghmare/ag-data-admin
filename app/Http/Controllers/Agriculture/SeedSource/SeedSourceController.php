...
namespace App\Http\Controllers\Agriculture\SeedSource;
...
use App\Services\Agriculture\SeedSource\SeedSourceService;
...
class SeedSourceController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/seed-source";

    /**
     * Injects SeedSource Service dependency through the constructor
     *
     * @param SeedSourceService $service
     *
     * @return Void
     */
    public function __construct(SeedSourceService $service, SeedSource $model)
    {
     ...
     *
     *@link http://agriculture/seed-source
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new SeedSource
     *
     *@link http://agriculture/seed-source/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/seed-source/store
     *
     *@method POST
     *
     * @param SeedSourceRequest $request
     *
     * @return \Illuminate\Http\RedirectResponse
     */
    public function store(SeedSourceRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update SeedSource
     *
     *@link http://agriculture/seed-source/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findSeedSourceById($id);
     ...
     *
     *@link http://agriculture/seed-source/update/id
     *
     *@method PATCH/PUT
     *
     * @param SeedSourceRequest  $request The request object
     * @param int $id The request object
     *
     * @return request
     */
    public function update(SeedSourceRequest $request, int $id)
    {
        $data = null;
        $code = "SUCCESS";
        try {
