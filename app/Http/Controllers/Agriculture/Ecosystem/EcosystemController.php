...
namespace App\Http\Controllers\Agriculture\Ecosystem;
...
use App\Services\Agriculture\Ecosystem\EcosystemService;
...
class EcosystemController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/ecosystem";

    /**
     * Injects Ecosystem Service dependency through the constructor
     *
     * @param EcosystemService $service
     *
     * @return Void
     */
    public function __construct(EcosystemService $service, Ecosystem $model)
    {
     ...
     *
     *@link http://agriculture/ecosystem
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new Ecosystem
     *
     *@link http://agriculture/ecosystem/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/ecosystem/store
     *
     *@method POST
     *
    ...
    /**
     * Displays a form with values to update Ecosystem
     *
     *@link http://agriculture/ecosystem/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findEcosystemById($id);
     ...
     *
     *@link http://agriculture/ecosystem/update/id
     *
     *@method PATCH/PUT
     *
     * @param EcosystemRequest  $request The request object
