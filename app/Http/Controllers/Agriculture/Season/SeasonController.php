...
namespace App\Http\Controllers\Agriculture\Season;
...
use App\Services\Agriculture\Season\SeasonService;
...
class SeasonController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/season";

    /**
     * Injects Season Service dependency through the constructor
     *
     * @param SeasonService $service
     *
     * @return Void
     */
    public function __construct(SeasonService $service, Season $model)
    {
    ...
    /**
     * Displays a form to add new Season
     *
     *@link http://agriculture/season/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/season/store
     *
     *@method POST
     *
    ...
    /**
     * Displays a form with values to update Season
     *
     *@link http://agriculture/season/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findSeasonById($id);
     ...
     *
     *@link http://agriculture/season/update/id
     *
     *@method PATCH/PUT
     *
     * @param SeasonRequest  $request The request object
