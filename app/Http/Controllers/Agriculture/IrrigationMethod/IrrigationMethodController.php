...
namespace App\Http\Controllers\Agriculture\IrrigationMethod;
...
use App\Services\Agriculture\IrrigationMethod\IrrigationMethodService;
...
class IrrigationMethodController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/irrigation-method";

    /**
     * Injects IrrigationMethod Service dependency through the constructor
     *
     * @param IrrigationMethodService $service
     *
     * @return Void
     */
    public function __construct(IrrigationMethodService $service, IrrigationMethod $model)
    {
     ...
     *
     *@link http://agriculture/irrigation-method
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new IrrigationMethod
     *
     *@link http://agriculture/irrigation-method/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/irrigation-method/store
     *
     *@method POST
     *
    ...
    /**
     * Displays a form with values to update IrrigationMethod
     *
     *@link http://agriculture/irrigation-method/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findIrrigationMethodById($id);
     ...
     *
     *@link http://agriculture/irrigation-method/update/id
     *
     *@method PATCH/PUT
     *
     * @param IrrigationMethodRequest  $request The request object
