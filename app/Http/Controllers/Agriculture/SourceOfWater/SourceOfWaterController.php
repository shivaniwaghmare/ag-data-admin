...
namespace App\Http\Controllers\Agriculture\SourceOfWater;
...
use App\Services\Agriculture\SourceOfWater\SourceOfWaterService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Agriculture\SourceOfWater\SourceOfWaterRequest;

class SourceOfWaterController extends Controller
{
     ...
     */
    private string $baseUrl = "/agriculture/source-of-water";

    /**
     * Injects SourceOfWater Service dependency through the constructor
     *
     * @param SourceOfWaterService $service
     *
     * @return Void
     */
    public function __construct(SourceOfWaterService $service, SourceOfWater $model)
    {
     ...
     *
     *@link http://agriculture/source-of-water
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new SourceOfWater
     *
     *@link http://agriculture/source-of-water/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/source-of-water/store
     *
     *@method POST
     *
     ...
     */
    public function store(SourceOfWaterRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update SourceOfWater
     *
     *@link http://agriculture/source-of-water/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findSourceOfWaterById($id);
     ...
     *
     *@link http://agriculture/source-of-water/update/id
     *
     *@method PATCH/PUT
     *
     * @param SourceOfWaterRequest  $request The request object
