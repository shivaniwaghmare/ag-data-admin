...
namespace App\Http\Controllers\Geographical\VillageAlias;
...
use App\Services\Geographical\VillageAlias\VillageAliasService;
use App\Http\Requests\Geographical\VillageAlias\VillageAliasRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class VillageAliasController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/geographical/village-alias";

    /**
     * Injects VillageAlias Service dependency through the constructor
     *
     * @param VillageAliasService $service
     *
     * @return Void
     */
    public function __construct(VillageAliasService $service)
    {
     ...
     *
     *@link http://geographical/village-alias
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new VillageAlias
     *
     *@link http://geographical/village-alias/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://geographical/village-alias/store
     *
     *@method POST
     *
     ...
     */
    public function store(VillageAliasRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update VillageAlias
     *
     *@link http://geographical/village-alias/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findVillageAliasById($id);
     ...
     *
     *@link http://geographical/village-alias/update/id
     *
     *@method PATCH/PUT
     *
     * @param VillageAliasRequest  $request The request object
