...
namespace App\Http\Controllers\Geographical\StateAlias;
...
use App\Services\Geographical\StateAlias\StateAliasService;
use App\Http\Requests\Geographical\StateAlias\StateAliasRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class StateAliasController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/geographical/state-alias";

    /**
     * Injects StateAlias Service dependency through the constructor
     *
     * @param StateAliasService $service
     *
     * @return Void
     */
    public function __construct(StateAliasService $service)
    {
     ...
     *
     *@link http://geographical/state-alias
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new StateAlias
     *
     *@link http://geographical/state-alias/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://geographical/state-alias/store
     *
     *@method POST
     *
     ...
     */
    public function store(StateAliasRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update StateAlias
     *
     *@link http://geographical/state-alias/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStateAliasById($id);
     ...
     *
     *@link http://geographical/state-alias/update/id
     *
     *@method PATCH/PUT
     *
     * @param StateAliasRequest  $request The request object
