...
namespace App\Http\Controllers\Geographical\District;
...
use App\Services\Geographical\District\DistrictService;
...
class DistrictController extends Controller
{
    ...
    */
    private string $baseUrl = "/geographical/district";

    /**
     * Injects District Service dependency through the constructor
     *
     ...
     *
     *@link http://\Geographical/District
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new District
     *
     *@link http://\Geographical/District/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://\Geographical/District/store
     *
     *@method POST
     *
    ...
    public function store(DistrictRequest $request)
    {
     ...
     /**
     * Displays a form with values to update District
     *
     *@link http://\Geographical/District/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findDistrictById($id);
     ...
     *
     *@link http://\Geographical/District/update/id
     *
     *@method PATCH/PUT
     *
     * @param DistrictRequest  $request The request object
