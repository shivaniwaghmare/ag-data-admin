...
namespace App\Http\Controllers\Geographical\State;
...
use App\Services\Geographical\State\StateService;
...
class StateController extends Controller
{
    ...
    */
    private string $baseUrl = "/geographical/state";

    /**
     * Injects State Service dependency through the constructor
     *
    ...
    /**
     * Displays a form to add new State
     *
     *@link http://geographical/state/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://geographical/state/store
     *
     *@method POST
     *
    ...
    public function store(StateRequest $request)
    {
     ...
     /**
     * Displays a form with values to update State
     *
     *@link http://geographical/state/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStateById($id);
     ...
     *
     *@link http://geographical/state/update/id
     *
     *@method PATCH/PUT
     *
     * @param StateRequest  $request The request object
