...
namespace App\Http\Controllers\Geographical\DistrictAlias;
...
use App\Services\Geographical\DistrictAlias\DistrictAliasService;
use App\Http\Requests\Geographical\DistrictAlias\DistrictAliasRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class DistrictAliasController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/geographical/district-alias";

    /**
     * Injects DistrictAlias Service dependency through the constructor
     *
     * @param DistrictAliasService $service
     *
     * @return Void
     */
    public function __construct(DistrictAliasService $service)
    {
     ...
     *
     *@link http://\Geographical/district-alias
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new DistrictAlias
     *
     *@link http://\Geographical/district-alias/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://\Geographical/district-alias/store
     *
     *@method POST
     *
     ...
     */
    public function store(DistrictAliasRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update DistrictAlias
     *
     *@link http://\Geographical/district-alias/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findDistrictAliasById($id);
     ...
     *
     *@link http://\Geographical/district-alias/update/id
     *
     *@method PATCH/PUT
     *
     * @param DistrictAliasRequest  $request The request object
