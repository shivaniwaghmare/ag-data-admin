...
namespace App\Http\Controllers\Geographical\Panchayat;
...
use App\Services\Geographical\Panchayat\PanchayatService;
...
class PanchayatController extends Controller
{
    ...
    */
    private string $baseUrl = "/geographical/panchayat";

    /**
     * Injects Panchayat Service dependency through the constructor
     *
     * @param PanchayatService $service
     *
     * @return Void
     */
    public function __construct(PanchayatService $service)
    {
     ...
     *
     *@link http://geographical/panchayat
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new Panchayat
     *
     *@link http://geographical/panchayat/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://geographical/panchayat/store
     *
     *@method POST
     *
     ...
     */
    public function store(PanchayatRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update Panchayat
     *
     *@link http://geographical/panchayat/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findPanchayatById($id);
     ...
     *
     *@link http://geographical/panchayat/update/id
     *
     *@method PATCH/PUT
     *
     * @param PanchayatRequest  $request The request object
