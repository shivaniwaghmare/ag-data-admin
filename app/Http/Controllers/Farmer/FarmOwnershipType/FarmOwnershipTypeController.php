...
namespace App\Http\Controllers\Farmer\FarmOwnershipType;
...
use App\Services\Farmer\FarmOwnershipType\FarmOwnershipTypeService;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Farmer\FarmOwnershipType\FarmOwnershipTypeRequest;

class FarmOwnershipTypeController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/farm-ownership-type";

    /**
     * Injects FarmOwnershipType Service dependency through the constructor
     *
     * @param FarmOwnershipTypeService $service
     *
     * @return Void
     */
    public function __construct(FarmOwnershipTypeService $service, FarmOwnershipType $model)
    {
     ...
     *
     *@link http://farmer/farm-ownership-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmOwnershipType
     *
     *@link http://farmer/farm-ownership-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farm-ownership-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmOwnershipTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmOwnershipType
     *
     *@link http://farmer/farm-ownership-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmOwnershipTypeById($id);
     ...
     *
     *@link http://farmer/farm-ownership-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmOwnershipTypeRequest  $request The request object
