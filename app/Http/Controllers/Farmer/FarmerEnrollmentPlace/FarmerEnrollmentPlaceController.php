...
namespace App\Http\Controllers\Farmer\FarmerEnrollmentPlace;
...
use App\Services\Farmer\FarmerEnrollmentPlace\FarmerEnrollmentPlaceService;
use App\Http\Requests\Farmer\FarmerEnrollmentPlace\FarmerEnrollmentPlaceRequest;

class FarmerEnrollmentPlaceController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/enrollment-place";

    /**
     * Injects FarmerEnrollmentPlace Service dependency through the constructor
     *
     * @param FarmerEnrollmentPlaceService $service
     *
     * @return Void
     */
    public function __construct(FarmerEnrollmentPlaceService $service, FarmerEnrollmentPlace $model)
    {
     ...
     *
     *@link http://farmer/farmer-enrollment-place
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerEnrollmentPlace
     *
     *@link http://farmer/farmer-enrollment-place/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-enrollment-place/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerEnrollmentPlaceRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerEnrollmentPlace
     *
     *@link http://farmer/farmer-enrollment-place/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerEnrollmentPlaceById($id);
     ...
     *
     *@link http://farmer/farmer-enrollment-place/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerEnrollmentPlaceRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:farmer_enrollment_place'
            ];
