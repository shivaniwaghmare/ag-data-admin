...
namespace App\Http\Controllers\Farmer\EducationFarmer;
...
use App\Services\Farmer\EducationFarmer\EducationFarmerService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Farmer\EducationFarmer\EducationFarmerRequest;

class EducationFarmerController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/education-farmer";

    /**
     * Injects EducationFarmer Service dependency through the constructor
     *
     * @param EducationFarmerService $service
     *
     * @return Void
     */
    public function __construct(EducationFarmerService $service, EducationFarmer $model)
    {
     ...
     *
     *@link http://farmer/education-farmer
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new EducationFarmer
     *
     *@link http://farmer/education-farmer/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/education-farmer/store
     *
     *@method POST
     *
     ...
     */
    public function store(EducationFarmerRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update EducationFarmer
     *
     *@link http://farmer/education-farmer/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findEducationFarmerById($id);
     ...
     *
     *@link http://farmer/education-farmer/update/id
     *
     *@method PATCH/PUT
     *
     * @param EducationFarmerRequest  $request The request object
