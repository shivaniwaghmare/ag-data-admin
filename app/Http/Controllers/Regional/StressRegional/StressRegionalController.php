...
namespace App\Http\Controllers\Regional\StressRegional;
...
use App\Services\Regional\StressRegional\StressRegionalService;
use App\Http\Requests\Regional\StressRegional\StressRegionalRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class StressRegionalController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/regional/stress-regional";

    /**
     * Injects StressRegional Service dependency through the constructor
     *
     * @param StressRegionalService $service
     *
     * @return Void
     */
    public function __construct(StressRegionalService $service)
    {
     ...
     *
     *@link http://regional/stress-regional
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new StressRegional
     *
     *@link http://regional/stress-regional/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://regional/stress-regional/store
     *
     *@method POST
     *
     ...
     */
    public function store(StressRegionalRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update StressRegional
     *
     *@link http://regional/stress-regional/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStressRegionalById($id);
     ...
     *
     *@link http://regional/stress-regional/update/id
     *
     *@method PATCH/PUT
     *
     * @param StressRegionalRequest  $request The request object
