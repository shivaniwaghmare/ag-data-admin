...
namespace App\Http\Controllers\Regional\BankRegional;
...
use App\Services\Regional\BankRegional\BankRegionalService;
use App\Http\Requests\Regional\BankRegional\BankRegionalRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class BankRegionalController extends Controller
{
    ...
    */
    private string $baseUrl = "/regional/bank-regional";

    /**
     * Injects BankRegional Service dependency through the constructor
     *
     * @param BankRegionalService $service
     *
     * @return Void
     */
    public function __construct(BankRegionalService $service, BankRegional $model)
    {
     ...
     *
     *@link http://regional/bank-regional
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new BankRegional
     *
     *@link http://regional/bank-regional/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://regional/bank-regional/store
     *
     *@method POST
     *
     ...
     */
    public function store(BankRegionalRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update BankRegional
     *
     *@link http://regional/bank-regional/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findBankRegionalById($id);
     ...
     *
     *@link http://regional/bank-regional/update/id
     *
     *@method PATCH/PUT
     *
     * @param BankRegionalRequest  $request The request object
