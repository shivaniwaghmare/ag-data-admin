...
namespace App\Http\Controllers\Regional\Terrain;
...
use App\Services\Regional\Terrain\TerrainService;
...
class TerrainController extends Controller
{
    ...
    */
    private string $baseUrl = "/regional/terrain";

    /**
     * Injects Terrain Service dependency through the constructor
     *
     * @param TerrainService $service
     *
     * @return Void
     */
    public function __construct(TerrainService $service)
    {
    ...
    /**
     * Displays a form to add new Terrain
     *
     *@link http://regional/terrain/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://regional/terrain/store
     *
     *@method POST
     *
    ...
    public function store(TerrainRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Terrain
     *
     *@link http://regional/terrain/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findTerrainById($id);
     ...
     *
     *@link http://regional/terrain/update/id
     *
     *@method PATCH/PUT
     *
     * @param TerrainRequest  $request The request object
