...
namespace App\Http\Controllers\Regional\LanguageRegional;
...
use App\Services\Regional\LanguageRegional\LanguageRegionalService;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Regional\LanguageRegional\LanguageRegionalRequest;

class LanguageRegionalController extends Controller
{
    ...
    */
    private string $baseUrl = "/regional/language-regional";

    /**
     * Injects LanguageRegional Service dependency through the constructor
     *
     * @param LanguageRegionalService $service
     *
     * @return Void
     */
    public function __construct(LanguageRegionalService $service, LanguageRegional $model)
    {
     ...
     *
     *@link http://regional/language-regional
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new LanguageRegional
     *
     *@link http://regional/language-regional/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://regional/language-regional/store
     *
     *@method POST
     *
     ...
     */
    public function store(LanguageRegionalRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update LanguageRegional
     *
     *@link http://regional/language-regional/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findLanguageRegionalById($id);
     ...
     *
     *@link http://regional/language-regional/update/id
     *
     *@method PATCH/PUT
     *
     * @param LanguageRegionalRequest  $request The request object
