...
namespace App\Http\Controllers\General\BankBranch;
...
use App\Services\General\BankBranch\BankBranchService;
...
class BankBranchController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/bank-branch";

    /**
     * Injects BankBranch Service dependency through the constructor
     *
     * @param BankBranchService $service
     *
     * @return Void
     */
    public function __construct(BankBranchService $service, BankBranch $model)
    {
    ...
    /**
     * Displays a form to add new BankBranch
     *
     *@link http://general/bank-branch/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/bank-branch/store
     *
     *@method POST
     *
    ...
    public function store(BankBranchRequest $request)
    {
     ...
     /**
     * Displays a form with values to update BankBranch
     *
     *@link http://general/bank-branch/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findBankBranchById($id);
     ...
     *
     *@link http://general/bank-branch/update/id
     *
     *@method PATCH/PUT
     *
     * @param BankBranchRequest  $request The request object
