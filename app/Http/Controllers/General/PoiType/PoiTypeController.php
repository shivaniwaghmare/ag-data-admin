...
namespace App\Http\Controllers\General\PoiType;
...
use App\Services\General\PoiType\PoiTypeService;
...
class PoiTypeController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/poi-type";

    /**
     * Injects PoiType Service dependency through the constructor
     *
     * @param PoiTypeService $service
     *
     * @return Void
     */
    public function __construct(PoiTypeService $service,PoiType $model)
    {
    ...
    /**
     * Displays a form to add new PoiType
     *
     *@link http://general/poi-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/poi-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(PoiTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update PoiType
     *
     *@link http://general/poi-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findPoiTypeById($id);
     ...
     *
     *@link http://general/poi-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param PoiTypeRequest  $request The request object
