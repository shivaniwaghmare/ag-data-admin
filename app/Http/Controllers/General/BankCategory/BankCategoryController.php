...
namespace App\Http\Controllers\General\BankCategory;
...
use App\Services\General\BankCategory\BankCategoryService;
...
class BankCategoryController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/bank-category";

    /**
     * Injects BankCategory Service dependency through the constructor
     *
     * @param BankCategoryService $service
     *
     * @return Void
     */
    public function __construct(BankCategoryService $service, BankCategory $model)
    {
     ...
     *
     *@link http://general/bank-category
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new BankCategory
     *
     *@link http://general/bank-category/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/bank-category/store
     *
     *@method POST
     *
     ...
     */
    public function store(BankCategoryRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update BankCategory
     *
     *@link http://general/bank-category/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findBankCategoryById($id);
     ...
     *
     *@link http://general/bank-category/update/id
     *
     *@method PATCH/PUT
     *
     * @param BankCategoryRequest  $request The request object
