...
namespace App\Http\Controllers\General\ModeOfPayment;
...
use App\Services\General\ModeOfPayment\ModeOfPaymentService;
...
class ModeOfPaymentController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/mode-of-payment";

    /**
     * Injects ModeOfPayment Service dependency through the constructor
     *
     * @param ModeOfPaymentService $service
     *
     * @return Void
     */
    public function __construct(ModeOfPaymentService $service,ModeOfPayment $model)
    {
     ...
     *
     *@link http://general/mode-of-payment
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new ModeOfPayment
     *
     *@link http://general/mode-of-payment/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/mode-of-payment/store
     *
     *@method POST
     *
    ...
    public function store(ModeOfPaymentRequest $request)
    {
     ...
     /**
     * Displays a form with values to update ModeOfPayment
     *
     *@link http://general/mode-of-payment/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findModeOfPaymentById($id);
     ...
     *
     *@link http://general/mode-of-payment/update/id
     *
     *@method PATCH/PUT
     *
     * @param ModeOfPaymentRequest  $request The request object
