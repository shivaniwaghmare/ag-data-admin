...
namespace App\Http\Controllers\General\TypeOfService;
...
use App\Services\General\TypeOfService\TypeOfServiceService;
...
class TypeOfServiceController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/type-of-service";

    /**
     * Injects TypeOfService Service dependency through the constructor
     *
     * @param TypeOfServiceService $service
     *
     * @return Void
     */
    public function __construct(TypeOfServiceService $service,TypeOfService $model)
    {
     ...
     *
     *@link http://general/type-of-service
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new TypeOfService
     *
     *@link http://general/type-of-service/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/type-of-service/store
     *
     *@method POST
     *
     ...
     */
    public function store(TypeOfServiceRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update TypeOfService
     *
     *@link http://general/type-of-service/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findTypeOfServiceById($id);
     ...
     *
     *@link http://general/type-of-service/update/id
     *
     *@method PATCH/PUT
     *
     * @param TypeOfServiceRequest  $request The request object
