...
namespace App\Http\Controllers\General\Company;
...
use App\Services\General\Company\CompanyService;
...
class CompanyController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/company";

    /**
     * Injects Company Service dependency through the constructor
     *
     * @param CompanyService $service
     *
     * @return Void
     */
    public function __construct(CompanyService $service, Company $model)
    {
    ...
    /**
     * Displays a form to add new Company
     *
     *@link http://general/company/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/company/store
     *
     *@method POST
     *
    ...
    public function store(CompanyRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Company
     *
     *@link http://general/company/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findCompanyById($id);
     ...
     *
     *@link http://general/company/update/id
     *
     *@method PATCH/PUT
     *
     * @param CompanyRequest  $request The request object
