...
namespace App\Http\Controllers\General\CallingStatus;
...
use App\Services\General\CallingStatus\CallingStatusService;
...
class CallingStatusController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/calling-status";

    /**
     * Injects CallingStatus Service dependency through the constructor
     *
     * @param CallingStatusService $service
     *
     * @return Void
     */
    public function __construct(CallingStatusService $service,CallingStatus $model)
    {
     ...
     *
     *@link http://general/calling-status
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CallingStatus
     *
     *@link http://general/calling-status/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/calling-status/store
     *
     *@method POST
     *
     ...
     */
    public function store(CallingStatusRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update CallingStatus
     *
     *@link http://general/calling-status/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findCallingStatusById($id);
     ...
     *
     *@link http://general/calling-status/update/id
     *
     *@method PATCH/PUT
     *
     * @param CallingStatusRequest  $request The request object
