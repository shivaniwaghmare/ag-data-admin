...
namespace App\Http\Controllers\General\DropReason;
...
use App\Services\General\DropReason\DropReasonService;
...
class DropReasonController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/drop-reason";

    /**
     * Injects DropReason Service dependency through the constructor
     *
     * @param DropReasonService $service
     *
     * @return Void
     */
    public function __construct(DropReasonService $service,DropReason $model)
    {
    ...
    /**
     * Displays a form to add new DropReason
     *
     *@link http://general/drop-reason/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/drop-reason/store
     *
     *@method POST
     *
     ...
     */
    public function store(DropReasonRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update DropReason
     *
     *@link http://general/drop-reason/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findDropReasonById($id);
     ...
     *
     *@link http://general/drop-reason/update/id
     *
     *@method PATCH/PUT
     *
     * @param DropReasonRequest  $request The request object
