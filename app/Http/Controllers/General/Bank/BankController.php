...
namespace App\Http\Controllers\General\Bank;
...
use App\Services\General\Bank\BankService;
...
class BankController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/bank";

    /**
     * Injects Bank Service dependency through the constructor
     *
     * @param BankService $service
     *
     * @return Void
     */
    public function __construct(BankService $service,Bank $model)
    {
    ...
    /**
     * Displays a form to add new Bank
     *
     *@link http://general/bank/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function store(BankRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Bank
     *
     *@link http://general/bank/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findBankById($id);
     ...
     *
     *@link http://general/bank/update/id
     *
     *@method PATCH/PUT
     *
     * @param BankRequest  $request The request object
