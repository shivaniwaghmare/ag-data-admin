...
namespace App\Http\Controllers\General\PackagingType;
...
use App\Services\General\PackagingType\PackagingTypeService;
...
class PackagingTypeController extends Controller
{
    ...
    */
    private string $baseUrl = "/general/packaging-type";

    /**
     * Injects PackagingType Service dependency through the constructor
     *
     * @param PackagingTypeService $service
     *
     * @return Void
     */
    public function __construct(PackagingTypeService $service)
    {
     ...
     *
     *@link http://general/packaging-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new PackagingType
     *
     *@link http://general/packaging-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://general/packaging-type/store
     *
     *@method POST
     *
    ...
    public function store(PackagingTypeRequest $request)
    {
     ...
     /**
     * Displays a form with values to update PackagingType
     *
     *@link http://general/packaging-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findPackagingTypeById($id);
     ...
     *
     *@link http://general/packaging-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param PackagingTypeRequest  $request The request object
