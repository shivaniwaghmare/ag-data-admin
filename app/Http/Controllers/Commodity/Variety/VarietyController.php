...
namespace App\Http\Controllers\Commodity\Variety;
...
use App\Services\Commodity\Variety\VarietyService;
...
class VarietyController extends Controller
{
     ...
     */
    private string $baseUrl = "/commodity/variety";
     ...
     * @return Void
     */
    public function __construct(VarietyService $service)
    {
     ...
     *
     *@link http://commodity/variety/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://commodity/variety/store
     *
     *@method POST
     *
     ...
     *
     *@link http://commodity/variety/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findVarietyById($id);
     ...
     *
     *@link http://commodity/variety/update/id
     *
     *@method PATCH/PUT
     *
