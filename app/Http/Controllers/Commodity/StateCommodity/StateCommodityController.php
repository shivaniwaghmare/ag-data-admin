...
namespace App\Http\Controllers\Commodity\StateCommodity;
...
use App\Services\Commodity\StateCommodity\StateCommodityService;
use App\Http\Requests\Commodity\StateCommodity\StateCommodityRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class StateCommodityController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/commodity/state-commodity";

    /**
     * Injects StateCommodity Service dependency through the constructor
     *
     * @param StateCommodityService $service
     *
     * @return Void
     */
    public function __construct(StateCommodityService $service)
    {
     ...
     *
     *@link http://commodity/state-commodity
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new StateCommodity
     *
     *@link http://commodity/state-commodity/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://commodity/state-commodity/store
     *
     *@method POST
     *
     ...
     */
    public function store(StateCommodityRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update StateCommodity
     *
     *@link http://commodity/state-commodity/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStateCommodityById($id);
     ...
     *
     *@link http://commodity/state-commodity/update/id
     *
     *@method PATCH/PUT
     *
     * @param StateCommodityRequest  $request The request object
