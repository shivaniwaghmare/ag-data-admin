...
namespace App\Http\Controllers\Commodity\QualityParameter;
...
use App\Services\Commodity\QualityParameter\QualityParameterService;
...
class QualityParameterController extends Controller
{
    ...
    */
    private string $baseUrl = "/commodity/quality-parameter";

    /**
     * Injects QualityParameter Service dependency through the constructor
     *
     * @param QualityParameterService $service
     *
     * @return Void
     */
    public function __construct(QualityParameterService $service)
    {
     ...
     *
     *@link http://commodity/quality-parameter
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new QualityParameter
     *
     *@link http://commodity/quality-parameter/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://commodity/quality-parameter/store
     *
     *@method POST
     *
     ...
     */
    public function store(QualityParameterRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update QualityParameter
     *
     *@link http://commodity/quality-parameter/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findQualityParameterById($id);
     ...
     *
     *@link http://commodity/quality-parameter/update/id
     *
     *@method PATCH/PUT
     *
     * @param QualityParameterRequest  $request The request object
