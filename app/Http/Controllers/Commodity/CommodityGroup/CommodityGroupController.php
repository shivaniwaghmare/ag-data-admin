...
namespace App\Http\Controllers\Commodity\CommodityGroup;
...
use App\Services\Commodity\CommodityGroup\CommodityGroupService;
...
class CommodityGroupController extends Controller
{
    ...
    */
    private string $baseUrl = "/commodity/commodity-group";

    /**
     * Injects CommodityGroup Service dependency through the constructor
     *
     * @param CommodityGroupService $service
     *
     * @return Void
     */
    public function __construct(CommodityGroupService $service)
    {
     ...
     *
     *@link http://commodity/commodity-group
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CommodityGroup
     *
     *@link http://commodity/commodity-group/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://commodity/commodity-group/store
     *
     *@method POST
     *
     ...
     */
    public function store(CommodityGroupRequest $request)
    {
       $data = null;
       $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update CommodityGroup
     *
     *@link http://commodity/commodity-group/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findCommodityGroupById($id);
     ...
     *
     *@link http://commodity/commodity-group/update/id
     *
     *@method PATCH/PUT
     *
     * @param CommodityGroupRequest  $request The request object
