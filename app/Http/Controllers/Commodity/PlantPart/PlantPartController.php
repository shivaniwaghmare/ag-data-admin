...
namespace App\Http\Controllers\Commodity\PlantPart;
...
use App\Services\Commodity\PlantPart\PlantPartService;
...
class PlantPartController extends Controller
{
    ...
    */
    private string $baseUrl = "/commodity/plant-part";

    /**
     * Injects PlantPart Service dependency through the constructor
     *
     * @param PlantPartService $service
     *
     * @return Void
     */
    public function __construct(PlantPartService $service, PlantPart $model)
    {
     ...
     *
     *@link http://commodity/plant-part
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new PlantPart
     *
     *@link http://commodity/plant-part/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://commodity/plant-part/store
     *
     *@method POST
     *
     ...
     */
    public function store(PlantPartRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update PlantPart
     *
     *@link http://commodity/plant-part/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findPlantPartById($id);
     ...
     *
     *@link http://commodity/plant-part/update/id
     *
     *@method PATCH/PUT
     *
     * @param PlantPartRequest  $request The request object
    ...
    */
    public function import(ImportValidationRequest $importValidationRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:agri_plant_part'
            ];
