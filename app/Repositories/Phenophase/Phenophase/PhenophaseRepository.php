...
namespace App\Repositories\Phenophase\Phenophase;

use Exception;
use App\Models\Phenophase\Phenophase;
use App\Http\Requests\Phenophase\Phenophase\PhenophaseRequest;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use App\Repositories\Phenophase\Phenophase\RepoInterface\PhenophaseRepoInterface;
...
class PhenophaseRepository implements PhenophaseRepoInterface
{
    ...
    /**
     * Find all Phenophase as per condition for dropdown listing
     * @param string $on The field to search
     * @param string $search The value to search with a like '%%' wildcard
     */
    ...
    {
        try {
            return Phenophase::findOrFail($id);
