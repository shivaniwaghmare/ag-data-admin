...
namespace App\Repositories\General\BankCategory;

use Exception;
use App\Models\General\BankCategory;
use App\Http\Requests\General\BankCategory\BankCategoryRequest;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use App\Repositories\General\BankCategory\RepoInterface\BankCategoryRepoInterface;

class BankCategoryRepository implements BankCategoryRepoInterface
{
    /**
     * Find BankCategories and get results in pagination
    ...
    {
        try {
            return BankCategory::getTableFields();
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    {
        try {
            return BankCategory::getFormFields();
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    {
        try {
            return BankCategory::findOrFail($id);
    ...
    public function updateStatusReject(array $id)
    {
        try {
            ...
            return BankCategory::whereIn("ID", $ids)
