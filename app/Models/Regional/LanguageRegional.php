...
class LanguageRegional extends Model
{
     use HasFactory;
     ...
     * @var string
     */
    protected $table = 'regional_language';
    ...
    protected static $tableFields = [
        ...
        [
            ...
            'formComponent' => 'RegularSelect',
            'options' => [],
            'source' => "/farmer/language-farmer/list",
            'mount' => true,
            'validations' => [
                'required' => true,
            ],
    ...
    /**
     * Get the State associated with the Geographical State.
     *
     * @return object
     */
    ...
    /**
     * Get the Language associated with the Farmer Language.
     *
     * @return object
     */
