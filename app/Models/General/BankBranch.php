...
class BankBranch extends Model
{
     ...
     * @var string
     */
    protected $table = 'general_bank_branch';
    ...
    protected static $tableFields = [
       ...
       [
           ...
           'formComponent' => 'RegularSelect',
           'options' => [],
           'source' => "/geographical/district/list",
           'mount' => true,
           'validations' => [
               'required' => true,
           ],
    ...
    /**
     * Get the Branch associated with the Bank branch.
     *
     * @return object
     */
    ...
    /**
     * Get the discrict associated with the bank .
     *
     * @return object
     */
