...
class Bank extends Model
{
    ...
    protected static $tableFields = [
       ...
       [
            ...
            'options' => [],
            'source' => "/general/bank-category/list",
            'mount' => true,
            'validations' => [
                'required' => true,
            ],
    ...
    /**
     * Get the bankCategory associated with the Bank.
     *
     * @return object
     */
    public function bankCategory()
    {
        return $this->belongsTo(
            related: BankCategory::class,
            foreignKey: 'BankCategoryID',
            ownerKey: 'ID'
        );
