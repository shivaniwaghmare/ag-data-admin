...
class StateCommodity extends Model
{
     use HasFactory;
     ...
     * @var string
     */
    protected $table = 'agri_state_commodity';
    ...
    /**
     * Get the State associated with the StateCommodity.
     *
     * @return object
     */
    ...
    /**
     * Get the Commodity associated with the StateCommodity.
     *
     * @return object
     */
