...
class CommodityStress extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'agri_commodity_stress';
    ...
    /**
     * Get the Commodity associated with the CommodityStress.
     *
     * @return object
     */
    ...
    /**
     * Get the stress associated with the commodity stress.
     *
     * @return object
     */
