...
class Stress extends Model
{
    ...
    /**
     * Get the Stress type associated with the Stress.
     *
     * @return object
     */
    public function stressType()
    {
        return $this->belongsTo(
            related: StressType::class,
            foreignKey: 'StressTypeID',
            ownerKey: 'ID'
        );
    }
}
