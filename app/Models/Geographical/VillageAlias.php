...
class VillageAlias extends Model
{
     ...
     * @var string
     */
    protected $table = 'geo_village_alias';
    ...
    [
        ...
        'formComponent' => 'RegularSelect',
        'options' => [],
        'source' => "/geographical/village/list-by-parent",
        'watching' => "TehsilCode",
        'mount' => true,
        'validations' => [
            'required' => true,
    ...
    public function tehsil()
    {
     ...
     /**
     * Get the villageGroup associated with the Tehsil.
     *
     * @return object
     */
