...
namespace App\Services\Stress\Stage;

use Exception;
use App\Http\Requests\Stress\Stage\StageRequest;
use App\Repositories\Stress\Stage\StageRepository;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use App\Http\Resources\Stress\Stage\Lists\StageListResource;
use App\Http\Resources\Stress\Stage\Lists\StageListCollection;
use App\Http\Resources\Stress\Stage\Table\StageTableCollection;
...
class StageService
{
    ...
    public function getAllPaginatedTableData(String $on = null, String $search = null)
    {
        ...
        try {
            return new StageTableCollection($this->repository->find($on, $search, $rowsPerPage));
        } catch (Exception $e) {
            throw $e;
        }
    }
     ...
     *
     * @return  StageListCollection
     */
    public function getAllRecords($on = "", $search = "")
    {
        return new  StageListCollection(
    ...
    public function findStageById(int $id)
    {
        try {
            ...
            return collect(new StageListResource($this->repository->findById($id)));
        } catch (NotFoundHttpException $e) {
            throw $e;
        } catch (Exception $e) {
            throw $e;
